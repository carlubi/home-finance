-- Incluir gastos fijos recurrentes en el resumen mensual y por categoria.
...
select
  ...
  coalesce(e.total, 0) + coalesce(fixed.total, 0) + coalesce(inv.total, 0) as total_expenses,
